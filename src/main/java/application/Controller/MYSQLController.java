...
import application.CRUD.MYSQLCRUD;
...
public class MYSQLController implements Initializable, ControllerImpl {
    ...
    @FXML
    public void guardarCoche(ActionEvent event) throws SQLException {
        /*
    ...
    @FXML
    public void modificarCoche(ActionEvent event) throws SQLException {
        /*
    ...
    @FXML
    public void eliminarCoche(ActionEvent event) throws SQLException {
        /*
    ...
    @FXML
    public void getCoche(MouseEvent event) {
    ...
    public void salir(ActionEvent event) {
        ...
        crud.desconectar();
        CambioEscenas.cambioEscena("inicioConcesionario.fxml", concesionario);
    }
